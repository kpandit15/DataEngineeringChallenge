...
This project uses [UV](https://docs.astral.sh/uv/) for fast, modern Python package management. UV provides faster dependency resolution and better reproducibility compared to traditional pip/venv workflows.
...
git clone https://github.com/kpandit15/DataEngineeringChallenge.git
cd DataEngineeringChallenge

# Setup environment and install all dependencies (one command!)
uv sync

# Test the setup
uv run python -c "import pandas, matplotlib, pendulum; print('Setup successful!')"
...
# Activate shell (optional - uv run is preferred)
source .venv/bin/activate  # Linux/Mac
# or
.venv\Scripts\activate     # Windows
```

For more details about the UV migration, see [UV_MIGRATION.md](UV_MIGRATION.md).
